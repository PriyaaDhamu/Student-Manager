...
--->SETUP STEPS
1.Download all the three files(index.html,main.js and style.cs) into the same folder.
2.Ensure all the files are in the same directory.



--->HOW TO RUN
1.Open the project folder.
2.Double click index.html or right click it and choose open it with browser.Now,the application will open in your browser.
3.Use the form to manage student data.
